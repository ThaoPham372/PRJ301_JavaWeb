...
<html lang="en">
  ...
  <body>
    <div class="topbar">
      ...
      <div>
        Hello, <b>${sessionScope.user.username}</b> (<span style="color: blue"
    ...
    <a href="${pageContext.request.contextPath}/products?action=new" class="add"
      >➕ Add New Product</a
    >
    <a
    ...
    <c:if test="${not empty totalPages}">
      <div class="pagination">
        <c:forEach begin="1" end="${totalPages}" var="i">
          <a
            href="${pageContext.request.contextPath}/products?action=list&page=${i}"
